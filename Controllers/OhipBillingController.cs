...
namespace TechSupportHelpSystem.Controllers
{
    ...
    public class OhipBillingController : ControllerBase
    {
        ...
        [HttpGet("{id_Client}")]
        public OHIPClinicGroupNumber Get(int id_Client, int id_Clinic)
        {
        ...
        [HttpPut("{id_Client}")]
        public HttpResponseMessage Put([FromBody] OHIPClinicGroupNumber clinicOptions, int id_Client)
        {
            return OHIPClinicService.EditClinicOptions(id_Client, clinicOptions);
        }

        // DELETE api/<OhipBillingController>/5
        [HttpPut("{id_Client}/{id_Clinic}")]
        public HttpResponseMessage Delete(int id_Client, int id_Clinic)
        {
            return OHIPClinicService.DeleteClinicOptions(id_Client, id_Clinic);
        }
    }
}
